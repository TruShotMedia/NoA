...
function buildJobProperties(schema, values, options = {}) {
  ...
  assignWhenPresent(properties, schema, values, options, 'clientId', assignRelation, ['Clients', 'Client']);
...
function mapNotionClient(page) {
  ...
  return {
    ...
    email: readFirstText(properties, ['Email', 'Contact Email']),
    phone: readFirstText(properties, ['Phone', 'Phone Number']),
    notes: readFirstText(properties, ['Notes', 'Description']),
    url: page.url,
...
function mapNotionTask(page, jobById = {}) {
  ...
  return {
    ...
    taskTypes: readFirstMultiSelect(properties, ['Task type']),
    assignedTo,
...
function mapNotionUpcomingJob(page, clientById = {}) {
  ...
  const dueDate = readFirstDate(properties, ['Due Date', 'Due date']);
  const status = readStatusLike(properties.Status);
  const clientIds = readFirstRelationIds(properties, ['Clients', 'Client']);
